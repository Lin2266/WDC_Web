...
<form name="form1" id="form1">
	...
	<table class="formbody">
		<tr>
			<th>欄位一：</th>
			<td>
				<t:input type="checkbox" name="col1" value="v1" label="值1"/> &nbsp;
				<t:input type="checkbox" name="col1" value="v2" label="值2" checked="checked"/> &nbsp;
				<t:input type="checkbox" name="col1" value="v3" label="值3"/> &nbsp;
				<t:input type="checkbox" name="col1" value="v4" label="值4"/> &nbsp;
			</td>
		</tr>
	</table>
</form>
code：
<code>&lt;t:input type="checkbox" name="col1" value="v1" label="值1"/&gt;
&lt;t:input type="checkbox" name="col1" value="v2" label="值2" checked="checked"/&gt;
&lt;t:input type="checkbox" name="col1" value="v3" label="值3"/&gt;
&lt;t:input type="checkbox" name="col1" value="v4" label="值4"/&gt;
</code>
...
<h3>說明</h3>
<ol>
	<li>亦可直接使用原始 HTML &lt;input type="checkbox"/&gt; 標籤實作
	<li>確定 JSP 檔頭已存在 &lt;%@ taglib prefix="ta" uri="commons.tatung.com" %&gt; 宣告
	<li>使用 &lt;<b>t:input</b> type="<b>checkbox</b>"/&gt; 標籤
		<div class="enum">
			<b>&lt;t:input type="checkbox"&gt;</b> 擁有如下屬性：
			<ol>
				<li><b>name</b>： (string)
				<li><b>type</b>： (string) 在此專指 checkbox
				<li><b>value</b>： (string) 欄位值
				<li><b><i>label</i></b>： (string) 與本 checkbox 對應的 label 文字
...
<div class="footer">
	<hr/>
	原始碼：<a href="${pageContext.request.contextPath}/sourceview/web/demo002025.jsp.txt" target="_blank">demo002025.jsp</a>
</div>
