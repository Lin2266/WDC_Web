...
@BackingBean("/demo00100302")
public class Demo00100302 {
	private static final Logger log = LoggerFactory.getLogger(Demo00100302.class);

	@AjaxAction
	public String queryAction(@Input(name="pk") Long pk) {
